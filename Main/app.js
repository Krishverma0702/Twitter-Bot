...
tweet_text_area.addEventListener('keyup', () => {
    ...
    // Get the stored chatbot response from localStorage
    const chatbotMessage = localStorage.getItem('chatbot-message');

    // Display the stored chatbot response

    const responseElement = document.getElementById('response');
    responseElement.textContent = ` ${chatbotMessage}`;


    // Clear the stored chatbot response from localStorage
    localStorage.removeItem('chatbot-message');
